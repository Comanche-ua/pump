...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cq34CMbT.mjs");
...
var manifest = {
	"20a1501ea31ab31877d5af2cba4e0094eed54602f4bd1ba000514001de94eaf3": {
		functionName: "pingTelegram_createServerFn_handler",
		importer: () => import("./pulse-CmKrfGe4.mjs")
	},
	"85885db196ec472c08bc2c35fa89baa86abe8eb5066abb08c37e5621af05da56": {
		functionName: "findTelegramChat_createServerFn_handler",
		importer: () => import("./pulse-CmKrfGe4.mjs")
	},
	"90d8df1024e79a5766f0ef8152bc6586dad1af67cbb4fafe38f8ae34e5d3a9a4": {
		functionName: "scanMarket_createServerFn_handler",
		importer: () => import("./pulse-CmKrfGe4.mjs")
	},
	"982cf8053b5280b37dbc7618e9b971c1062dd43e8955390265b7876235a5070a": {
		functionName: "fetchSymbolChart_createServerFn_handler",
		importer: () => import("./pulse-CmKrfGe4.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CaY4uMCG.mjs").then((n) => n.t),
